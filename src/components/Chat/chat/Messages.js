...
export default function Messages(props) {
  const { account,activeAccount, chatText, setChatText ,socket} = useContext(AccountContext);
...
useEffect(()=>{
    incommingMessage&&props.conversation?.members?.includes(incommingMessage.senderId)&&
  ...
  return (
    <div>
      <div className="h-[72vh] relative w-[100%]  overflow-y-scroll overflow-hidden">
        <img
          src={url}
          alt={"chat background"}
